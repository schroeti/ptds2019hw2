...
# We decided to display the result of the problem in a table format in order to make the RMarkdown more attractive and professional.
df2 <- df[1:10,]
df2 <- rbind(df2,c(df[11:20,]),c(df[21:30,]),c(df[31:40,]),c(df[41:50,]),c(df[51:60,]),c(df[61:70,]),c(df[71:80,]),c(df[81:90,]),c(df[91:100,]))
